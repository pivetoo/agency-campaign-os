...
namespace AgencyCampaign.Domain.Entities
{
    public sealed class OpportunityApprovalDiff : Entity
    {
        ...
        public OpportunityApprovalDiff(long opportunityApprovalRequestId, string field, string policyValue, string requestedValue, OpportunityApprovalDiffKind kind = OpportunityApprovalDiffKind.Change, string? delta = null, int displayOrder = 0, bool isAutoGenerated = false)
        {
