...
namespace AgencyCampaign.Api.Contracts.CampaignDeliverables
{
    public sealed class CampaignDeliverableContract
    {
        ...
        public long DeliverableKindId { get; init; }
        ...
        public PlatformReferenceContract? Platform { get; init; }
        ...
        public static Expression<Func<CampaignDeliverable, CampaignDeliverableContract>> Projection => item => new CampaignDeliverableContract
        {
            ...
            DeliverableKindId = item.DeliverableKindId,
            ...
            CampaignCreator = item.CampaignCreator == null ? null : new CampaignCreatorReferenceContract
            {
            ...
            DeliverableKind = item.DeliverableKind == null ? null : new DeliverableKindReferenceContract
            {
                Id = item.DeliverableKind.Id,
                Name = item.DeliverableKind.Name
            },
            Platform = item.Platform == null ? null : new PlatformReferenceContract
            {
                Id = item.Platform.Id,
    ...
    public sealed class DeliverableKindReferenceContract
    {
        public long Id { get; init; }
        public string Name { get; init; } = string.Empty;
    }

    public sealed class PlatformReferenceContract
    {
        public long Id { get; init; }
        public string Name { get; init; } = string.Empty;
    }
