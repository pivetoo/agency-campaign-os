...
import { Button, Card, CardContent, CardHeader, CardTitle, Badge } from 'archon-ui'
      ...
      <div className="flex min-h-screen items-center justify-center bg-muted/40">
        <Card className="max-w-md">
          <CardContent className="flex flex-col items-center gap-3 py-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">Solicite um novo link de aprovação à agência.</p>
          </CardContent>
        </Card>
      </div>
    )
    ...
    <div className="min-h-screen bg-muted/40 py-8">
      <div className="mx-auto max-w-2xl space-y-4 px-4">
        <Card>
          <CardHeader>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              {view.creatorName ? `Creator: ${view.creatorName}` : null}
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                ...
                {view.approvalStatus ? (
                  ...
                  <Badge variant="warning">Aguardando decisão</Badge>
                )}
              </div>
            </div>
        ...
        {decisionTaken ? (
          <Card>
            <CardContent className="space-y-2 py-6">
              ...
              {view.approvalComment && (
                <p className="text-sm text-muted-foreground">Comentário: {view.approvalComment}</p>
              )}
            </CardContent>
          </Card>
        ) : (
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Aprovar ou rejeitar entrega</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  placeholder="Compartilhe ajustes ou aprovações específicas"
                />
              </div>
