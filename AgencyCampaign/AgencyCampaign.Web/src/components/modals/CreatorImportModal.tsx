...
interface CreatorImportModalProps {
  open: boolean
  onOpenChange: (open: boolean) => void
}

const CSV_TEMPLATE_HEADERS = 'nome,nome_artistico,nicho,cidade,estado,email,telefone,documento,fee_padrao,ativo'
const CSV_TEMPLATE_EXAMPLE = 'Maria Silva,Marii,Moda,São Paulo,SP,maria@email.com,(11) 99999-9999,123.456.789-00,15.00,Sim'
...
function downloadTemplate() {
  ...
  a.href = url
  a.download = 'modelo_influenciadores.csv'
  a.click()
  URL.revokeObjectURL(url)
}

export default function CreatorImportModal({ open, onOpenChange }: CreatorImportModalProps) {
  ...
  return (
    <Modal open={open} onOpenChange={handleClose}>
      <ModalContent size="md">
        <ModalHeader>
          <ModalTitle>Importar influenciadores</ModalTitle>
        </ModalHeader>
