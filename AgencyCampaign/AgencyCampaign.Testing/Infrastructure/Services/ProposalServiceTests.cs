...
namespace AgencyCampaign.Testing.Infrastructure.Services
{
    ...
    public sealed class ProposalServiceTests
    {
        ...
        public void SetUp()
        {
            ...
            service = new ProposalService(db, CurrentUserMock.Create(), financial.Object, automation.Object, notifications.Object, IntegrationPlatformClientFactory.CreateInert(), new AutomationService(db));
        }
