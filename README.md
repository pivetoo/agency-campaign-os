...
- A probabilidade de cada oportunidade é derivada automaticamente do estágio (a partir da `DefaultProbability` dele); não há entrada manual por oportunidade. Ela existe apenas para ponderar o forecast (estágio final ganho = 100%, perdido = 0%).
